...
export const CHAINS_TESTNET = [
    {...polygonMumbai, img: require("@/assets/images/img/net-Polygon.png"), alias: "Polygon"}, 
    {...optimismSepolia, img: require("@/assets/images/img/net-Optimism.png"), alias: "Optimism"}
]
